...
const HouseAdvertForm = () => {
  ...
  return (
    <>
        <Typography sx={{ml: 5, mt: 3}} variant='h4'>Ev İlanı Yayınla</Typography>
        <Divider/>
        <Box mt={3} mb={10} sx={{display: "flex", justifyContent: "center"}}>
        <form onSubmit={handleSubmit}>
            ...
            <Button variant='contained' type='submit' color='error' startIcon={(loading) ? <CircularProgress sx={{color: "white"}}/> : null}>Yayınla</Button>
            </Stack>
        </form>
